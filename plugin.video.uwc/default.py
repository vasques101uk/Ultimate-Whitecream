...
def INDEXS():
    ...
    utils.addDir('[COLOR yellow]Thepornnation[/COLOR]','http://thepornempire.com/category/videos/',120,os.path.join(imgDir, 'thepornnation.png'),'')
...
def INDEXM():    
    ...
    utils.addDir('[COLOR yellow]Thepornnation[/COLOR]','http://thepornempire.com/category/movies/',125,os.path.join(imgDir, 'thepornnation.png'),'')
